...
Preferences _$PreferencesFromJson(Map<String, dynamic> json) => Preferences(
      ...
      autoDeleteMode: (json['auto_delete_mode'] as num?)?.toInt(),
      ...
      maxActiveDownloads: (json['max_active_downloads'] as num?)?.toInt(),
      maxActiveTorrents: (json['max_active_torrents'] as num?)?.toInt(),
      maxActiveUploads: (json['max_active_uploads'] as num?)?.toInt(),
      dontCountSlowTorrents: json['dont_count_slow_torrents'] as bool?,
      slowTorrentDlRateThreshold:
          (json['slow_torrent_dl_rate_threshold'] as num?)?.toInt(),
      slowTorrentUlRateThreshold:
          (json['slow_torrent_ul_rate_threshold'] as num?)?.toInt(),
      slowTorrentInactiveTimer:
          (json['slow_torrent_inactive_timer'] as num?)?.toInt(),
      ...
      maxConnec: (json['max_connec'] as num?)?.toInt(),
      maxConnecPerTorrent: (json['max_connec_per_torrent'] as num?)?.toInt(),
      maxUploads: (json['max_uploads'] as num?)?.toInt(),
      maxUploadsPerTorrent: (json['max_uploads_per_torrent'] as num?)?.toInt(),
      stopTrackerTimeout: (json['stop_tracker_timeout'] as num?)?.toInt(),
      ...
      altDlLimit: (json['alt_dl_limit'] as num?)?.toInt(),
      altUpLimit: (json['alt_up_limit'] as num?)?.toInt(),
      schedulerEnabled: json['scheduler_enabled'] as bool?,
      scheduleFromHour: (json['schedule_from_hour'] as num?)?.toInt(),
      scheduleFromMin: (json['schedule_from_min'] as num?)?.toInt(),
      scheduleToHour: (json['schedule_to_hour'] as num?)?.toInt(),
      scheduleToMin: (json['schedule_to_min'] as num?)?.toInt(),
      schedulerDays:
      ...
      proxyPort: (json['proxy_port'] as num?)?.toInt(),
      ...
      webUiPort: (json['web_ui_port'] as num?)?.toInt(),
      ...
      webUiMaxAuthFailCount:
          (json['web_ui_max_auth_fail_count'] as num?)?.toInt(),
      webUiBanDuration: (json['web_ui_ban_duration'] as num?)?.toInt(),
      webUiSessionTimeout: (json['web_ui_session_timeout'] as num?)?.toInt(),
      ...
      rssRefreshInterval: (json['rss_refresh_interval'] as num?)?.toInt(),
      rssMaxArticlesPerFeed:
          (json['rss_max_articles_per_feed'] as num?)?.toInt(),
      ...
      diskCache: (json['disk_cache'] as num?)?.toInt(),
      diskCacheTtl: (json['disk_cache_ttl'] as num?)?.toInt(),
      embeddedTrackerPort: (json['embedded_tracker_port'] as num?)?.toInt(),
      ...
      filePoolSize: (json['file_pool_size'] as num?)?.toInt(),
      outgoingPortsMax: (json['outgoing_ports_max'] as num?)?.toInt(),
      outgoingPortsMin: (json['outgoing_ports_min'] as num?)?.toInt(),
      ...
      saveResumeDataInterval:
          (json['save_resume_data_interval'] as num?)?.toInt(),
      sendBufferLowWatermark:
          (json['send_buffer_low_watermark'] as num?)?.toInt(),
      sendBufferWatermark: (json['send_buffer_watermark'] as num?)?.toInt(),
      sendBufferWatermarkFactor:
          (json['send_buffer_watermark_factor'] as num?)?.toInt(),
      socketBacklogSize: (json['socket_backlog_size'] as num?)?.toInt(),
      ...
      upnpLeaseDuration: (json['upnp_lease_duration'] as num?)?.toInt(),
